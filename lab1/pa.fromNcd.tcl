...
create_project -name lab01 -dir "Z:/groups/02/lab1/planAhead_run_1" -part xc7z020clg484-3
...
link_design
read_xdl -file "Z:/groups/02/lab1/lab1_top.ncd"
if {[catch {read_twx -name results_1 -file "Z:/groups/02/lab1/lab1_top.twx"} eInfo]} {
   puts "WARNING: there was a problem importing \"Z:/groups/02/lab1/lab1_top.twx\": $eInfo"
}
